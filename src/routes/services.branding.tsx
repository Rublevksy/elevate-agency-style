        ...
        <div className="container-luxe relative grid lg:grid-cols-12 gap-12">
          <aside className="lg:col-span-2 hidden lg:block pt-20">
            <div className="sticky top-32">
              <div className="h-px w-14 bg-amber-300 mb-4" />
              <p className="text-[10px] font-mono uppercase tracking-[0.35em] text-amber-300/80 [writing-mode:vertical-rl]">Identity system</p>
            </div>
          </aside>
          <div className="lg:col-span-10">
            <Link to="/services" className="inline-flex items-center gap-2 text-xs uppercase tracking-widest text-amber-300/80 hover:text-foreground transition-colors mb-12">
              <ArrowLeft className="h-3.5 w-3.5" /> Všechny služby
            </Link>
            <p className="text-xs font-mono uppercase tracking-[0.3em] text-amber-300 mb-6">Branding & logo</p>
          ...
          <div className="lg:col-span-8 divide-y divide-border border-y border-border">
            {[{ Icon: Aperture, t: "logo" }, { Icon: Palette, t: "barvy" }, { Icon: Type, t: "typografie" }].map(({ Icon, t }, i) => (
              <div key={t} className="py-7 flex items-center gap-6">
                <span className="text-xs font-mono text-amber-300/70 w-10">0{i + 1}</span>
      ...
      <section className="py-24 md:py-32 border-t border-border bg-surface/30">
        <div className="container-luxe">
          <div className="flex items-end justify-between gap-8 flex-wrap mb-12">
            <div>
              <p className="text-xs uppercase tracking-[0.25em] text-amber-300 mb-4">Varianty</p>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="aspect-[16/10] rounded-xl border border-border bg-background p-10 flex flex-col justify-between">
              <span className="text-[10px] font-mono uppercase tracking-[0.3em] text-amber-300/70">minimalist logo</span>
            ...
            <div className="aspect-[16/10] rounded-xl border border-border bg-gradient-to-br from-amber-300/20 to-transparent p-10 flex items-center justify-center">
            ...
            <div className="aspect-[16/10] rounded-xl border border-border bg-background p-10 flex flex-col items-center justify-center gap-5">
              <div className="h-20 w-20 rounded-2xl bg-gradient-to-br from-amber-300 to-primary grid place-items-center text-background text-4xl">▲</div>
      ...
      <section className="py-24 md:py-32 border-t border-border">
        <div className="container-luxe grid md:grid-cols-2 gap-px bg-border rounded-xl overflow-hidden">
          ...
          <div className="bg-surface/40 p-12">
            <p className="text-xs uppercase tracking-widest text-amber-300 mb-6">Nezávazná konzultace zdarma</p>
