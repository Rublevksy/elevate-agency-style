...
export const translations = {
  CZ: {
    common: {
      ...
      replyIn24h: "Odpovíme do 24 hodin",
    },
    home: {
      tag: "Digitální agentura",
      title1: "Tvoříme weby,",
      title2: "které vydělávají.",
      subtitle: "Pomáháme firmám získávat klienty online.",
      ctaSecondary: "Naše práce",
      trustLine: { years: "4+ let", yearsLabel: "zkušeností", projects: "50+", projectsLabel: "projektů", reply: "Odpověď do", replyValue: "24 hodin" },
      servicesEyebrow: "Co děláme",
      servicesTitle: "Služby zaměřené na výsledky",
      services: [
      ...
      portfolioEyebrow: "Vybrané projekty",
      portfolioTitle: "Práce, která přináší výsledky",
      ctaTitle: "Máš projekt?",
      ctaSubtitle: "Navrhneme ti řešení zdarma.",
    },
    aboutPage: {
      eyebrow: "O nás",
      title: "Jsme digitální agentura zaměřená na výsledky.",
      subtitle: "Tvoříme webové stránky a digitální řešení, která reálně pomáhají firmám růst — ne jen vypadat dobře.",
      stats: [
        { n: "4+", l: "let zkušeností" },
        { n: "50+", l: "realizovaných projektů" },
        { n: "12+", l: "oborů a odvětví" },
      ],
      approachEyebrow: "Náš přístup",
      story1: "Spojujeme strategii, design a technologii do jednoho celku, který pracuje pro vaše podnikání. Nejde nám o líbivý vizuál — jde nám o měřitelné výsledky.",
      story2: "Pracujeme s klienty z různých oborů — od profesionálních služeb a B2B firem až po e-commerce značky. Každý projekt začíná pochopením byznysu, ne výběrem barev.",
      valuesEyebrow: "Naše hodnoty",
      valuesTitle: "V čem jsme jiní",
      values: [
        { title: "Individuální přístup", desc: "Žádné šablony. Každý projekt řešíme od základu podle vašich cílů." },
        { title: "Rychlá komunikace", desc: "Odpovídáme do 24 hodin. Vždy víte, na čem jsme a co bude dál." },
        { title: "Důraz na kvalitu", desc: "Stavíme řešení, která dlouhodobě fungují — vizuálně i technicky." },
      ],
      exclusivityEyebrow: "Limitovaná spolupráce",
      exclusivityTitle: "Pracujeme pouze s omezeným počtem klientů.",
      exclusivityBody: "Abychom každému projektu mohli věnovat maximální pozornost, přijímáme jen několik nových spoluprací měsíčně.",
      free: "Nezávazná konzultace zdarma",
      individual: "Individuální přístup",
    },
    portfolioPage: {
      subtitleSection: "Reálné ukázky práce, problémů a výsledků",
    },
  ...
  EN: {
    common: {
      ...
      replyIn24h: "We reply within 24 hours",
    },
    home: {
      tag: "Digital agency",
      title1: "We build websites",
      title2: "that earn.",
      subtitle: "We help businesses win clients online.",
      ctaSecondary: "Our work",
      trustLine: { years: "4+ years", yearsLabel: "of experience", projects: "50+", projectsLabel: "projects", reply: "Reply within", replyValue: "24 hours" },
      servicesEyebrow: "What we do",
      servicesTitle: "Services focused on results",
      services: [
        { title: "Websites that bring clients", desc: "Fast websites built for conversion and growth." },
        { title: "E-shops that earn", desc: "Optimised for purchase from the first visit." },
        { title: "Branding", desc: "A brand people remember." },
      ],
      portfolioEyebrow: "Selected projects",
      portfolioTitle: "Work that delivers results",
      ctaTitle: "Got a project?",
      ctaSubtitle: "We'll design a solution for you, free.",
    },
    aboutPage: {
      eyebrow: "About",
      title: "We are a digital agency focused on results.",
      subtitle: "We build websites and digital solutions that genuinely help businesses grow — not just look good.",
      stats: [
        { n: "4+", l: "years of experience" },
        { n: "50+", l: "projects delivered" },
        { n: "12+", l: "industries and sectors" },
      ],
      approachEyebrow: "Our approach",
      story1: "We combine strategy, design and technology into one system that works for your business. We don't chase pretty visuals — we chase measurable results.",
      story2: "We work with clients across many industries — from professional services and B2B firms to e-commerce brands. Every project starts with understanding your business, not picking colors.",
      valuesEyebrow: "Our values",
      valuesTitle: "What makes us different",
      values: [
        { title: "Individual approach", desc: "No templates. Every project is built from scratch around your goals." },
        { title: "Fast communication", desc: "We reply within 24 hours. You always know where we stand." },
        { title: "Focus on quality", desc: "We build solutions that work long-term — visually and technically." },
      ],
      exclusivityEyebrow: "Limited collaboration",
      exclusivityTitle: "We only work with a limited number of clients.",
      exclusivityBody: "To give every project our full attention, we take on only a few new collaborations each month.",
      free: "Free, no-obligation consultation",
      individual: "Individual approach",
    },
    portfolioPage: {
      subtitleSection: "Real examples of work, problems and outcomes",
    },
  ...
  RU: {
    common: {
      ...
      getQuoteEmoji: "🚀 Получить предложение",
      ...
      replyIn24h: "Ответим в течение 24 часов",
    },
    home: {
      tag: "Цифровое агентство",
      title1: "Создаём сайты,",
      title2: "которые приносят прибыль.",
      subtitle: "Помогаем бизнесу получать клиентов онлайн.",
      ctaSecondary: "Наши работы",
      trustLine: { years: "4+ года", yearsLabel: "опыта", projects: "50+", projectsLabel: "проектов", reply: "Ответ в", replyValue: "24 часа" },
      servicesEyebrow: "Что мы делаем",
      servicesTitle: "Услуги, ориентированные на результат",
      services: [
        { title: "Сайты, которые приводят клиентов", desc: "Быстрые сайты для конверсии и роста." },
        { title: "Магазины, которые продают", desc: "Оптимизированы для покупки с первого визита." },
        { title: "Брендинг", desc: "Бренд, который запоминают." },
      ],
      portfolioEyebrow: "Избранные проекты",
      portfolioTitle: "Работы с измеримыми результатами",
      ctaTitle: "Есть проект?",
      ctaSubtitle: "Бесплатно подготовим решение.",
    },
    aboutPage: {
      eyebrow: "О нас",
      title: "Мы цифровое агентство, ориентированное на результат.",
      subtitle: "Делаем сайты и цифровые решения, которые реально помогают бизнесу расти — а не просто красиво выглядят.",
      stats: [
        { n: "4+", l: "года опыта" },
      ...
      story1: "Мы соединяем стратегию, дизайн и технологии в одну систему, которая работает на ваш бизнес. Нам важен не красивый визуал — нам важен измеримый результат.",
      story2: "Работаем с клиентами из разных отраслей — от профессиональных услуг и B2B до e-commerce-брендов. Каждый проект начинается с понимания бизнеса, а не с выбора цвета.",
      valuesEyebrow: "Наши ценности",
      valuesTitle: "Чем мы отличаемся",
      values: [
        { title: "Индивидуальный подход", desc: "Без шаблонов. Каждый проект — с нуля под ваши цели." },
        { title: "Быстрая коммуникация", desc: "Отвечаем в течение 24 часов. Вы всегда знаете, что происходит." },
        { title: "Фокус на качестве", desc: "Делаем решения, которые работают долго — визуально и технически." },
      ],
      exclusivityEyebrow: "Ограниченное сотрудничество",
      exclusivityTitle: "Работаем только с ограниченным числом клиентов.",
      exclusivityBody: "Чтобы уделять каждому проекту максимум внимания, берём лишь несколько новых сотрудничеств в месяц.",
      free: "Бесплатная консультация",
      individual: "Индивидуальный подход",
    },
    portfolioPage: {
      subtitleSection: "Реальные примеры работ, задач и результатов",
    },
  ...
  UA: {
    common: {
      ...
      getQuoteEmoji: "🚀 Отримати пропозицію",
      ...
      bookConsult: "Записатись на консультацію",
      replyIn24h: "Відповімо протягом 24 годин",
    },
    home: {
      tag: "Цифрова агенція",
      title1: "Створюємо сайти,",
      title2: "що приносять прибуток.",
      subtitle: "Допомагаємо бізнесу залучати клієнтів онлайн.",
      ctaSecondary: "Наші роботи",
      trustLine: { years: "4+ роки", yearsLabel: "досвіду", projects: "50+", projectsLabel: "проєктів", reply: "Відповідь у", replyValue: "24 години" },
      servicesEyebrow: "Що ми робимо",
      servicesTitle: "Послуги, орієнтовані на результат",
      services: [
        { title: "Сайти, що залучають клієнтів", desc: "Швидкі сайти для конверсії та зростання." },
        { title: "Магазини, що продають", desc: "Оптимізовані для покупки з першого візиту." },
        { title: "Брендинг", desc: "Бренд, який запам'ятовують." },
      ],
      portfolioEyebrow: "Вибрані проєкти",
      portfolioTitle: "Роботи з вимірними результатами",
      ctaTitle: "Маєш проєкт?",
      ctaSubtitle: "Безкоштовно підготуємо рішення.",
    },
    aboutPage: {
      eyebrow: "Про нас",
      title: "Ми цифрова агенція, орієнтована на результат.",
      subtitle: "Робимо сайти й цифрові рішення, що реально допомагають бізнесу зростати — а не лише гарно виглядають.",
      stats: [
        { n: "4+", l: "роки досвіду" },
      ...
      story1: "Поєднуємо стратегію, дизайн і технології в одну систему, що працює на ваш бізнес. Нам важливий не гарний візуал — нам важливий вимірний результат.",
      story2: "Працюємо з клієнтами з різних галузей — від професійних послуг і B2B до e-commerce-брендів. Кожен проєкт починається з розуміння бізнесу, а не вибору кольору.",
      valuesEyebrow: "Наші цінності",
      valuesTitle: "Чим ми відрізняємось",
      values: [
        { title: "Індивідуальний підхід", desc: "Без шаблонів. Кожен проєкт — з нуля під ваші цілі." },
        { title: "Швидка комунікація", desc: "Відповідаємо протягом 24 годин. Ви завжди знаєте, що відбувається." },
        { title: "Фокус на якості", desc: "Робимо рішення, що працюють довго — візуально й технічно." },
      ],
      exclusivityEyebrow: "Обмежена співпраця",
      exclusivityTitle: "Працюємо тільки з обмеженою кількістю клієнтів.",
      exclusivityBody: "Щоб приділяти кожному проєкту максимум уваги, беремо лише кілька нових співпраць на місяць.",
      free: "Безкоштовна консультація",
      individual: "Індивідуальний підхід",
    },
    portfolioPage: {
      subtitleSection: "Реальні приклади робіт, задач і результатів",
    },
