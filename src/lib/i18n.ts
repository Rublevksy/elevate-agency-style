  ...
  EN: {
    ...
    contact: {
      ...
      form: {
        stepLabel: "Step",
        stepOf: "of 3",
        stepTitles: ["What project are you planning?", "Contact details", "What's your approximate budget?"],
        ...
        messagePlaceholder: "Tell us a few sentences about your project and goals.",
        back: "Back",
        next: "Continue",
        submit: "Send inquiry",
        sending: "Sending...",
        noSpam: "No spam. Just a concrete proposal.",
        successTitle: "Message sent!",
        successBody: "We'll get back to you within 24 hours with next steps.",
        sendAgain: "Send another message",
        directEyebrow: "Or contact us directly",
        directText: "Phone, email or social — we reply quickly.",
        errors: {
          ...
          describeProject: "Please describe your project",
  ...
  RU: {
    ...
    contact: {
      ...
      form: {
        stepLabel: "Шаг",
        stepOf: "из 3",
        stepTitles: ["Какой проект вы планируете?", "Контактные данные", "Какой ориентировочный бюджет?"],
        ...
        phonePlaceholder: "+420 777 123 456",
        messageLabel: "Описание проекта",
        messagePlaceholder: "Напишите пару предложений о проекте и целях.",
        back: "Назад",
        next: "Продолжить",
        submit: "Отправить запрос",
        sending: "Отправка...",
        noSpam: "Никакого спама. Только конкретное предложение.",
        successTitle: "Сообщение отправлено!",
        successBody: "Ответим в течение 24 часов и предложим следующий шаг.",
        sendAgain: "Отправить ещё",
        directEyebrow: "Или напишите нам напрямую",
        directText: "Телефон, email или соцсети — отвечаем быстро.",
        errors: {
          ...
          describeProject: "Опишите, пожалуйста, проект",
  ...
  UA: {
    ...
    contact: {
      ...
      form: {
        stepLabel: "Крок",
        stepOf: "з 3",
        stepTitles: ["Який проєкт ви плануєте?", "Контактні дані", "Який орієнтовний бюджет?"],
        ...
        emailPlaceholder: "ivan@company.com",
        phonePlaceholder: "+420 777 123 456",
        messageLabel: "Опис проєкту",
        messagePlaceholder: "Напишіть кілька речень про проєкт і цілі.",
        back: "Назад",
        next: "Продовжити",
        submit: "Надіслати запит",
        sending: "Надсилаю...",
        noSpam: "Жодного спаму. Лише конкретна пропозиція.",
        successTitle: "Повідомлення надіслано!",
        successBody: "Відповімо протягом 24 годин і запропонуємо наступний крок.",
        sendAgain: "Надіслати ще",
        directEyebrow: "Або напишіть нам напряму",
        directText: "Телефон, email або соцмережі — відповідаємо швидко.",
        errors: {
          ...
          describeProject: "Опишіть, будь ласка, проєкт",
