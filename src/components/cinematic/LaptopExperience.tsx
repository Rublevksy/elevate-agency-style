...
export function LaptopExperience() {
  ...
  // ── camera ────────────────────────────────────────────────────────────────
  const tilt = useTransform(p, [0, 0.12, 0.3, 0.5, 0.76, 0.9, 1], [-38, -33, -22, 0, 0, -26, -42]);
  const yaw = useTransform(p, [0, 0.12, 0.3, 0.5, 0.76, 0.9, 1], [-16, -11, -4, 0, 0, 10, 18]);
  ...
  const zoom = useTransform(
    ...
    reduced ? [0.8, 0.8, 0.82, 0.86, 0.86, 0.82, 0.78] : [0.62, 0.66, 0.86, 3.4, 3.4, 0.84, 0.5],
  );
