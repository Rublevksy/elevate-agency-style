  ...
  return (
    <section id="portfolio" className="py-32 md:py-40 border-t border-border">
      <div className="container-luxe">
        <SectionHeading eyebrow="04" title={t.portfolio.title} subtitle={t.ui.portfolioSubtitle} />
            ...
            >
              ...
              <div className="p-6 md:p-8 flex flex-col gap-5 flex-1">
                ...
                <div className="grid grid-cols-2 gap-5 pt-4 border-t border-border">
                  <div>
                    <p className="text-[10px] uppercase tracking-[0.2em] text-muted-foreground mb-2">{t.ui.portfolioWork}</p>
                  ...
                  <div>
                    <p className="text-[10px] uppercase tracking-[0.2em] text-muted-foreground mb-2">{t.ui.portfolioResults}</p>
                    <ul className="space-y-1">
